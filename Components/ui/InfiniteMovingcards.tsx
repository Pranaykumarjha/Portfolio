    ...
    return (
        ...
        >
            ...
            >
                {items.map((item, idx) => (
                    <li
                        className="relative w-[350px] md:w-[450px]  shrink-0 
                        rounded-2xl border border-b-0 border-zinc-200 
                        bg-[linear-gradient(180deg,#fafafa,#f5f5f5)] px-8 py-6 md:w-[60vw]
                         dark:border-zinc-800 p-5 md:p-16 dark:bg-[linear-gradient(180deg,#27272a,#18181b)]"
                        style={{ background:'rgb(4,7,29)',
                            backgroundColor: "linear-gradient(135deg, #020617 0%, #1e293b 100%)" }}
                        key={`${item.name}-${idx}`}
                    >
                        <blockquote>
                            <div
